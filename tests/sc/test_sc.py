...
class FlaskTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        global test_user
        test_user = Node("User",
        sql_id=1, google_id="1142829874753334407", givenName="ISBTestUser", familyName="ISBTestUser", displayName="ISBTestUser",
        email="ISBTestUser@gmail.com", gender="male", dob="1989-03-19",
        image_url= "https://www.gstatic.com/webp/gallery3/1.png",
        user_type="subscriber", organization="Northeastern University", creation_time= 12345,
        modified_time= 12345, status=0)
        global graph
