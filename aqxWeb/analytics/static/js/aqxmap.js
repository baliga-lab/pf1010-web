...
(function() {
     ...
     function reset() {
         ...
         aqxmap.filterSystemsBasedOnDropdownValues();
     }
      ...
      */
     aqxmap.main = function(system_and_info_object) {
         var infoWindow;
         ...
         function initializeMap() {
             ...
             _.each(system_and_info_object, function(system_and_info) {
                        ...
                        if (system_and_info.marker !== null) system_and_info.marker.setVisible(true);
                        //else console.debug("no marker");
                    });
         }
         initializeMap();
         aqxmap.filterSystemsBasedOnDropdownValues();
      ...
      */
     aqxmap.filterSystemsBasedOnDropdownValues = function() {
